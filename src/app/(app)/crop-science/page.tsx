...
const commonCrops: CropInfo[] = [
  // Vegetables
  { name: 'Tomato', imageUrl: 'https://images.unsplash.com/photo-1571680322279-a226e6a4cc2a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHx0b21hdG98ZW58MHx8fHwxNzQ4MjM5MDMzfDA&ixlib=rb-4.1.0&q=80&w=1080', aiHint: 'tomato white-background', slug: 'tomato' },
