...
const commonCrops: CropInfo[] = [
  ...
  { name: 'Potato', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/potato.jpg', aiHint: 'potato vegetable', slug: 'potato', unoptimized: true },
  ...
  { name: 'Carrot', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/carrot.jpg', aiHint: 'carrot vegetable', slug: 'carrot', unoptimized: true },
  ...
  { name: 'Spinach', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/spinach.jpg', aiHint: 'spinach leaves', slug: 'spinach', unoptimized: true },
  { name: 'Bell Pepper', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/red-yellow-capsicum.jpg', aiHint: 'bell pepper', slug: 'bell-pepper', unoptimized: true },
  { name: 'Cucumber', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/cucumber.jpeg', aiHint: 'cucumber vegetable', slug: 'cucumber', unoptimized: true },
  ...
  { name: 'Bottle Gourd', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/bottle%20gourd.jpeg', aiHint: 'bottle gourd', slug: 'bottle-gourd', unoptimized: true },
  { name: 'Bitter Gourd', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/bitter%20gourd.jpeg', aiHint: 'bitter gourd', slug: 'bitter-gourd', unoptimized: true },
  { name: 'Cabbage', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/cabbage.jpeg', aiHint: 'cabbage vegetable', slug: 'cabbage', unoptimized: true },
  { name: 'Cauliflower', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/cauliflower.jpeg', aiHint: 'cauliflower vegetable', slug: 'cauliflower', unoptimized: true },
  { name: 'Radish', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/radish.jpeg', aiHint: 'radish vegetable', slug: 'radish', unoptimized: true },
  { name: 'Ridge Gourd', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/ridge%20gourd.jpeg', aiHint: 'ridge gourd', slug: 'ridge-gourd', unoptimized: true },
  ...
  { name: 'Grapes', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/grapes.jpg', aiHint: 'grapes fruit', slug: 'grapes', unoptimized: true },
  { name: 'Strawberry', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/strawberry%20(1).jpg', aiHint: 'strawberry fruit', slug: 'strawberry', unoptimized: true },
  { name: 'Pineapple', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/pineapple.jpg', aiHint: 'pineapple fruit', slug: 'pineapple', unoptimized: true },
  { name: 'Watermelon', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/watermelon.jpg', aiHint: 'watermelon fruit', slug: 'watermelon', unoptimized: true },
  { name: 'Pomegranate', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/pomegranade.jpg', aiHint: 'pomegranate fruit', slug: 'pomegranate', unoptimized: true },
  { name: 'Kiwi', imageUrl: 'https://storage.googleapis.com/imagesoffarmdocc/crop%20images/kiwi.jpg', aiHint: 'kiwi fruit', slug: 'kiwi', unoptimized: true },
];
